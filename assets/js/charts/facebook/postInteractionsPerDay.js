...
SR.Charts.FB_postInteractionsPerDay = new SR.Chart({
    id: 'FB_postInteractionsPerDay'
  , url: '/facebook/{{id}}/postInteractions'
  , testData: [
        { date: '2013-01-01', likes: 2, shares: 2, comments: 1 }
      , { date: '2013-01-02', likes: 4, shares: 1, comments: 2 }
      , { date: '2013-01-03', likes: 7, shares: 2, comments: 3 }
      , { date: '2013-01-04', likes: 5, shares: 3, comments: 1 }
      , { date: '2013-01-05', likes: 3, shares: 4, comments: 2 }
      , { date: '2013-01-06', likes: 2, shares: 5, comments: 2 }
      , { date: '2013-01-07', likes: 5, shares: 6, comments: 4 }
      , { date: '2013-01-08', likes: 8, shares: 5, comments: 3 }
      , { date: '2013-01-09', likes: 4, shares: 5, comments: 4 }
      , { date: '2013-01-10', likes: 5, shares: 6, comments: 5 }
      , { date: '2013-01-11', likes: 6, shares: 7, comments: 6 }
      , { date: '2013-01-12', likes: 7, shares: 8, comments: 7 }
      , { date: '2013-01-13', likes: 8, shares: 9, comments: 8 }
    ]
  , render: function (data, options) {
        ...
        data = data.map(function(day){
            ...
            var likes    = SR.util.toNumber(day.likes, 0)
              , shares   = SR.util.toNumber(day.shares, 0)
              , comments = SR.util.toNumber(day.comments, 0)
