...
SR.Charts.FB_postTimeline = new SR.Chart({
    id: 'FB_postTimeline'
  , url: '/facebook/{{id}}/postInteractions'
  , testData: [
        { date: '2013-01-01', likes: '2', shares: '2', comments: '1', title: 'Post title' }
      , { date: '2013-01-02', likes: '4', shares: '1', comments: '1', title: 'Post title' }
      , { date: '2013-01-03', likes: '7', shares: '2', comments: '1', title: 'Post title' }
      , { date: '2013-01-04', likes: '5', shares: '3', comments: '1', title: 'Post title' }
      , { date: '2013-01-05', likes: '1', shares: '1', comments: '1', title: 'Post title' }
    ]
  , render: function (data, options) {

        SR.log("Rendering %s", this.id, options)
